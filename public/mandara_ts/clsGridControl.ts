...
let gridControl = function(
    ...
    let Undo_InputCopyPasteClearInfo = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Rect; // Rectangle
        this.GridData; // String
    }
    let Undo_InsertRows = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Top; // Integer
        this.Bottom; // Integer
    }
    let Undo_InsertColumns = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Left; // Integer
        this.Right; // Integer
    }
    let Undo_DeleteRows = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Top; // Integer
        this.Bottom; // Integer
    ...
    let Undo_DeleteColumns = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Left; // Integer
        this.Right; // Integer
    ...
    let Undo_ChangeRowHeight = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Top; // Integer
        this.Bottom; // Integer
    ...
    let Undo_ChangeColumnWidth = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Left; // Integer
        this.Right; // Integer
    ...
    let Undo_ChangeLayerName = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
        this.Name; // String
    }
    let Undo_SwapLayer = function(this: any) {
        this.Layer1; // Integer
        this.Layer2; // Integer
        this.caption; // String
    }
    let Undo_MoveLayer = function(this: any) {
        this.OriginLay; // Integer
        this.DestLay; // Integer
        this.caption; // String
    }
    let Undo_deleteLayer = function(this: any) {
        this.OriginLay; // Integer
        this.GridData; // Grid_Info
        this.caption; // String
    }
    let Undo_InsertLayer = function(this: any) {
        this.Layer; // Integer
        this.caption; // String
    }


let UndoArray: any=[]; // New ArrayList
    ...
    let FixedDataItemData_Info = function(this: any) {
        this.Height; // Integer
        this.Allignment; // Windows.Forms.HorizontalAlignment
    }
    ...
    let FixedUpperLeft_Info = function(this: any) {
        this.Text=""; // String
        this.Allignment; // Windows.Forms.HorizontalAlignment
    }
    ...
    let CellData_Info = function(this: any) {
        this.Width; // Integer
        this.Allignment; // Windows.Forms.HorizontalAlignment
    }
    ...
    let GridTextColor_Info = function(this: any) {
        this.Text=""; // String
    ...
    let Operation_enable_info = function(this: any) {
    ...
    let Grid_Info = function(this: any) {
        ...
        this.FixedDataItemHeight = function () { // Integer
            let H = 0;
        ...
        this.FixedObjectNameDataWidth = function () { // Integer
            let W = 0;
        ...
        // @ts-expect-error TS(2554): Expected 1 arguments, but got 0.
        this.GridLineCol = new colorRGBA();; // Color
        ...
        this.MouseUpDownRect = function () {  // Rectangle
            // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    Grid_Info.prototype.Clone = function () {  // Grid_Info
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    let Grid_Property: any = [];//; // Grid_Info

    let Grid_Color = function(this: any) {
        // @ts-expect-error TS(2554): Expected 1 arguments, but got 0.
    ...
    let Grid_Total_Info = function(this: any) {
        this.initOK; // Boolean
    ...
    let inClipboard="";
    let Grid_Resize_Info = function(this: any) {
        this.Enable; // Integer
        this.GridX; // Integer
        this.GridY; // Integer
        this.LeftX; // Integer
 ...
 */
    this.init = function (LayerCaption: any, RowCaption: any, ColumnCaption: any, FixedXs: any, FixedXs2: any, FixedYs: any, FixedYS2: any,enableOperation: any,_eventCall: any) {
    ...
    /**サイズ変更 */
    this.changeSize = function (newWidth: any, newHeight: any) {
        width = newWidth;
        height = newHeight;
        this.width = width;
        this.height = height;
    ...
    /**レイヤ追加（メソッド） */
    this.addLayer = function (LayName: any, LayerNum: any, Xsize: any, Ysize: any, opeEnable = undefined) {
    ...
    /**データ項目追加  */
    this.addDataItem = function (Layer: any, AddPoint: any, AddNum: any) {
    ...
    this.addObject = function (Layer: any, AddPoint: any, AddNum: any) {
        if ((Layer < 0) || (Grid_Total.LayerNum < Layer)) {
            // @ts-expect-error TS(2554): Expected 3 arguments, but got 2.
            Generic.alert(undefined, "Layerが誤っています。");
            return;
    ...
    /** レイヤ削除*/
    this.removeLayer = function (Layer: any) {
    ...
    this.removeObject=function(Layer: any , RemovePoint: any , RemoveNum: any ) {
        if((Layer < 0)||(Grid_Total.LayerNum < Layer )){
            // @ts-expect-error TS(2554): Expected 3 arguments, but got 2.
            Generic.alert(undefined,"Layerが誤っています。");
            return;
    ...
    /**データ項目削除 */
    this.RemoveDataItem = function (Layer: any, RemovePoint: any, RemoveNum: any) {
        if ((Layer < 0) || (Grid_Total.LayerNum < Layer)) {
            // @ts-expect-error TS(2554): Expected 3 arguments, but got 2.
            Generic.alert(undefined, "Layerが誤っています。");
            return;
    ...
    this.Find = function (FindStr: any, MatchingMode: any) {
    ...
    /**逆方向検索 */
    this.FindRev = function (FindStr: any, MatchingMode: any) {
        let SPL = Grid_Total.Layer;
        let SX, SY;
        let GP = Grid_Property[SPL];
        if (GP.SelectedF == true) {
...
/**■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ プロパティメソッド**/
    ...
    /**内部のコピーデータに設定 */
    this.setCopyText=function(CopyData: any){
        inClipboard=CopyData;
    }

    /** グリッドの上端固定部分の文字*/
    this.setFixedDataItem = function (LayerNum: any, X: any, Y: any, value: any) {
        Grid_Property[LayerNum].FixedDataItem[X][Y].Text = value;
    }
    this.getFixedDataItem = function (LayerNum: any, X: any, Y: any) {
        return Grid_Property[LayerNum].FixedDataItem[X][Y].Text;
    }

    /** グリッドの左端固定部分の文字*/
    this.setFixedXSData = function (LayerNum: any, X: any, Y: any, value: any) {
        Grid_Property[LayerNum].FixedObjectName[X][Y].Text = value;
    }
   /**グリッドの左端固定部分の文字設定取得  XY指定なしの場合は配列で取得*/
   this.getFixedXSData = function (LayerNum: any, X=undefined, Y=undefined) {
    ...
    /**グリッドの中身設定 */
    this.setGridData = function (LayerNum: any, X: any, Y: any, value: any) {
        Grid_Property[LayerNum].Grid_Text[X][Y].Text = value;
    }
    this.getGridData = function (LayerNum: any, X: any, Y: any) {
        return Grid_Property[LayerNum].Grid_Text[X][Y].Text;
    }
    /**グリッドの左上固定部分設定 */
    this.setFixedUpperLeftData = function (LayerNum: any, X: any, Y: any, value: any) {
        Grid_Property[LayerNum].FixedUpperLeftData[X][Y].Text = value;
    }
    /**グリッドの左端固定部分の配置設定 */
    this.setFixedXSAllignment= function (LayerNum: any, X: any,value: any) {
        Grid_Property[LayerNum].FixedObjectNameData[X].Allignment=value;
    }
    this.getFixedUpperLeftData = function (LayerNum: any, X: any) {
    ...
    this.setLeftCell = function (v: any) {
    ...
    this.setTopCell = function (v: any) {
    ...
    this.setDefaultFixedXNumberingWidth = function (v: any) {
    ...
    this.setDefaultFixedXWidth = function (v: any) {
    ...
    this.setDefaultFixedUpperLeftAlligntment = function (v: any) {
    ...
    this.setDefaultFixedYSAllignment = function (v: any) {
    ...
    this.setDefaultFixedXSAllignment = function (v: any) {
    ...
    this.setDefaultGridAlligntment = function (v: any) {
        Grid_Total.DefaultGridAlligntment = v;
    }
    /**グリッドの選択範囲を取得 */
    this.getSelectedArea = function (LayerNum: any) {
    ...
    /**グリッドの横セル数取得 */
    this.getXsize = function (LayerNum: any) {
        return Grid_Property[LayerNum].Xmax;
    }
    /**グリッドの横セル数設定 */
    this.setXsize = function (LayerNum: any, value: any) {
    ...
    /**グリッドの縦セル数取得 */
    this.getYsize = function (LayerNum: any) {
        return Grid_Property[LayerNum].Ymax;
    }
    /**グリッドの縦セル数設定 */
    this.setYsize = function (LayerNum: any, value: any) {
    ...
    /**グリッドの位置を指定して表示 */
    this.SetGridPosition = function (LayerNum: any, LeftCell: any, TopCell: any) {
        let GP = Grid_Property[LayerNum];
    ...
    /**グリッドのデータを配列取得／取得のみ */
    this.getLayerGridData = function (LayerNum: any) {
        let GP = Grid_Property[LayerNum];
        let xs = GP.Xmax;
        let ys = GP.Ymax;
        // @ts-expect-error TS(2554): Expected 3 arguments, but got 2.
    ...
    /**グリッドの左上固定部分を配列取得 */
    this.getFixedUpperLeftData = function (LayerNum: any) {
        let GP = Grid_Property[LayerNum];
        let xs = Grid_Total.FixedObjectName_n;
    ...
    /** グリッドの左端固定部分の個別色設定*/
    this.getFixedXSColor = function (Layernum: any, X: any, Y: any) {
    ...
    this.setFixedXSColor = function (Layernum: any, X: any, Y: any,value: any) {
    ...
    this.FixedAllXSColorReset = function (LayerNum: any) {
        let GP = Grid_Property[LayerNum];
    ...
    /**グリッドの左端固定部分の色設定クリア */
    this.FixedXSColorReset = function (Layernum: any, X: any, Y: any) {
        Grid_Property[Layernum].FixedObjectName[X][Y].colorSetF = false;
    }

    /**グリッドの上端固定部分の文字設定取得 XY指定なしの場合は配列で取得*/
    this.getFixedYSData = function (LayerNum: any, X=undefined, Y=undefined) {
        let GP = Grid_Property[LayerNum];
        if (X != undefined) {
            // @ts-expect-error TS(2538): Type 'undefined' cannot be used as an index type.
    ...
    this.setFixedYSData = function (LayerNum: any, X: any, Y: any,value: any) {
        let GP = Grid_Property[LayerNum];
        GP.FixedDataItem[X][Y].Text = value;
    }

    /**グリッドの上端固定部分の個別色設定 */
    this.getFixedYSColor = function (Layernum: any, X: any, Y: any) {
    ...
    this.setFixedYSColor = function (Layernum: any, X: any, Y: any,value: any) {
    ...
    this.FixedAllYSColorReset = function (LayerNum: any) {
        let GP = Grid_Property[LayerNum];
    ...
    /**グリッドの上端固定部分の色設定クリア */
    this.FixedYSColorReset = function (Layernum: any, X: any, Y: any) {
        Grid_Property[Layernum].FixedDataItem[X][Y].colorSetF = false
    }


    /**グリッド上端固定部分の文字設定 */
    this.getFixedUpperLeftData = function (LayerNum: any, X: any, Y: any) {
    ...
    /** グリッドの高さ設定 */
    this.getGridHeight = function (LayerNum: any, Y: any) {
        return Grid_Property[LayerNum].CellHeight[Y]
    }
    this.setGridHeight = function (LayerNum: any,Y: any, value: any) {
        Grid_Property[LayerNum].CellHeight[Y] = value;
    }


    /** グリッドの幅設定 */
    this.getGridWidth = function (LayerNum: any, X: any) {
        return Grid_Property[LayerNum].DataItemData[X].Width;
    }
    this.set = function (LayerNum: any, X: any, value: any) {
        Grid_Property[LayerNum].DataItemData[X].Width = value;
    }

    /** グリッドの配置設定 */
    this.getGridAlligntment = function (LayerNum: any, X: any) {
        return Grid_Property[LayerNum].DataItemData[X].Allignment
    }
    this.setGridAlligntment = function (LayerNum: any, X: any, value: any) {
        Grid_Property[LayerNum].DataItemData[X].Allignment = value;
    }


    /** グリッドの左上固定部分の配置設定 */
    this.getFixedUpperLeftAlligntment = function (LayerNum: any) {
        return Grid_Property[LayerNum].FixedUpperLeftAllignment
    }
    this.setFixedUpperLeftAlligntment = function (LayerNum: any, value: any) {
        Grid_Property[LayerNum].FixedUpperLeftAllignment = value;
    }


    /** グリッドの左端固定部分の配置設定 */
    this.getFixedXSAllignment = function (LayerNum: any, n: any) {
        return Grid_Property[LayerNum].FixedObjectNameData[n].Allignment
    }
    this.setFixedXSAllignment = function (LayerNum: any, n: any, value: any) {
        Grid_Property[LayerNum].FixedObjectNameData[n].Allignment = value;
    }

    /** グリッドの左端固定部分の幅設定 */
    this.getFixedXSWidth = function (LayerNum: any, n: any) {
        return Grid_Property[LayerNum].FixedObjectNameData[n].Width
    }
    this.setFixedXSWidth = function (LayerNum: any, n: any, value: any) {
        Grid_Property[LayerNum].FixedObjectNameData[n].Width = value;
    }

    /** 上部固定部分の行ごとの配置設定 */
    this.getFixedYSAllignment = function (LayerNum: any, n: any) {
        return Grid_Property[LayerNum].FixedDataItemData[n].Allignment
    }
    this.setFixedYSAllignment = function (LayerNum: any, n: any, value: any) {
        Grid_Property[LayerNum].FixedDataItemData[n].Allignment = value;
    }

    /** 上部固定部分の行ごとの高さ設定 */
    this.getFixedYSHeight = function (LayerNum: any, n: any) {
        return Grid_Property[LayerNum].FixedDataItemData[n].Height
    }
    this.setFixedYSHeight = function (LayerNum: any, n: any, value: any) {
    ...
    this.getLayerData = function (LayerNum: any, key: any) {
        return Grid_Property[LayerNum].LayerData[key];
    }
    this.setLayerData = function (LayerNum: any, key: any, value: any) {
    ...
    this.setLayer = function (value: any) {
        Grid_Total.Layer = value;
    }

    /**レイヤ名を取得・設定 */
    this.getLayerName = function (LayerNum: any) {
        return Grid_Property[LayerNum].LayerName;
    }
    this.setLayerName = function (LayerNum: any, value: any) {
    ...
    this.setTabClickEnabled = function (value: any) {
    ...
    this.setTotalGridColor = function (value: any) {
        Grid_Total.Color.Grid = value;
    }

    /** セルの個別色設定 */
    this.getGridColor = function (LayerNum: any, X: any, Y: any) {
    ...
    this.setGridColor = function (LayerNum: any, X: any, Y: any,value: any) {
        Grid_Property[LayerNum].Grid_Text[X][Y].colorSetF = true;
        Grid_Property[LayerNum].Grid_Text[X][Y].Color = value;
    }

    /** レイヤのグリッドの色設定をすべてクリア */
    this.GridColorReset = function (LayerNum: any) {
        let GP = Grid_Property[LayerNum];
    ...
    /** グリッドの色設定クリア */
    this.getGridColorReset = function (LayerNum: any, X: any, Y: any) {
    ...
    this.setFixedGridColor = function (value: any) {
    ...
    this.setGridLineColor = function (value: any) {
    ...
    this.setRowCaption = function (value: any) {
    ...
    this.setLayerCaption = function (value: any) {
...
/**■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■ 内部関数*/
        ...
        for (let i = 0; i < Grid_Total.FixedObjectName_n; i++) {
            ...
            for (let j = 0; j < Grid_Total.FixedDataItem_n; j++) {
                ...
                if (GP.SelectedF == true) {
                    let dkf = false;
                    if (((MBX1 <= -(Grid_Total.FixedObjectName_n - i)) && (-(Grid_Total.FixedObjectName_n - i) <= MBX2)
                    ) && ((MBY1 <= -(Grid_Total.FixedDataItem_n - j)) && (-(Grid_Total.FixedDataItem_n - j) <= MBY2))) {
                        dkf = true;
                    }
                    if ((MBX1 <= -(Grid_Total.FixedObjectName_n - i)) && (-(Grid_Total.FixedObjectName_n - i) <= MBX2)) {
                        if (j < Grid_Total.FixedDataItem_n2) {
    ...
    function Get_Data_from_Grid(Grid_Lay: any, X: any, Y: any) {
        let tx;
...
function Grid_Clear(Caption: any ){
    let GP = Grid_Property[Grid_Total.Layer];
    ...
    function Get_Object_to_Cell_Size(X: any, Y: any, Obj: any) {
        let w, H;
        let n;
        let GP = Grid_Property[Grid_Total.Layer];
        let lef =0;
    ...
    function SetTextBox(X: any, Y: any) {
        let AL, n;
    ...
    function Print_Data(STT: any, Allignment: any, X: any, Y: any, CellW: any, CellHeight: any, BorderColor: any, Fillcolor: any, BorderWidth: any, font: any) {
    ...
    /**レイヤ追加（内部） */
    function Insert_Layer(LayName: any, lay: any, OriginalLayerNumber: any, xs: any, ys: any, OperationEnable: any) {
        Grid_Total.LayerNum++;
        tabMake();
...
function RaiseEvent(call: any){
if(call !=undefined){

}
}
    function rightClickmenu(pos: any){
        ...
        function mnuRowNumber() {
            ...
            removeEventlister();
            Generic.prompt(undefined, Grid_Total.RowCaption + "数指定", PV, function (SF: any) {
                if (SF != "") {
        ...
        function mnuColNumber(){
            ...
            removeEventlister();
            Generic.prompt(undefined, Grid_Total.ColumnCaption + "数指定", PV, function (SF: any) {
                if (SF != "") {
                    SF=Generic.convValue(SF);
                    if (isNaN(SF) == true) {
                        // @ts-expect-error TS(2554): Expected 3 arguments, but got 2.
    ...
    /** 行削除*/
    function DeleteRows(GridLay: any, DeletePoint: any, DeleteNum: any) {
    ...
    function InsertRows(GridLay: any, InsertPoint: any, InsertNum: any) {
        /** データ部分を挿入*/
        let GP = Grid_Property[GridLay];
        let oldYs = GP.Ymax;
    ...
    function DeleteColumns(GridLay: any, DeletePoint: any, DeleteNum: any) {
    ...
    function InsertColumns(GridLay: any, InsertPoint: any, InsertNum: any) {
    ...
    /** 固定行・列に番号をふる */
    function Set_FixedCell_Words(L: any) {
        let GP = Grid_Property[L];
    ...
    function  Set_Data_To_Grid( Grid_Lay: any ,  X: any ,  Y: any ,  tx: any ,  Check_F: any ){
        if (Check_F == true) {
            let gpo = Grid_Property[Grid_Total.Layer].Ope;
    ...
    function Get_XYData(Layer: any, X: any, Y: any) {
...
function Grid_Copy(){
    ...
    function SetUndo_CopyPasteCutClear(Caption: any){
    ...
    function SetUndo_ChangeRowHeight(Layer: any, top: any, bottom: any) {
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    function SetUndo_Input(X: any, Y: any, Caption: any) {
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    function  SetUndo_InsertRows(Caption: any , y: any , InsertNum: any ){
        //行挿入
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    function SetUndo_InsertColumns(Caption: any, x: any, InsertNum: any) {
        //列挿入
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    // 行削除のundo
    function SetUndo_DeleteRows(Caption: any, Y: any, DeleteNum: any) {
        let sb = "";
    ...
    ////// 列削除のundo
    function SetUndo_DeleteColumns(Caption: any, X: any, DeleteNum: any) {
        let sb = "";
    ...
    function Grid_Paste(clipText: any, UndoMode_Flag: any) {
    ...
    function Check_ChangeEvent(X: any , Y: any ){
    let f = false;
    let GPo= Grid_Property[Grid_Total.Layer].Ope;
...
function Check_ChangeEventRange(X: any , Y: any , Xn: any , Yn: any ){
    let GPo= Grid_Property[Grid_Total.Layer].Ope;
        if((Y < 0 )&&( X < 0 )&&(GPo.FixedUpperLeftEnabeld == true) ){
            eventCall.evtChange_FixedUpperLeft();
        }
    ...
    function tabMake() {
        ...
        /**タブクリック */
        function tabMouseDown(this: any, e: any) {
            //マウスダウンでレイヤ移動
            // @ts-expect-error TS(2339): Property 'getVisibility' does not exist on type 'H... Remove this comment to see the full error message
            if (txtTextBox.getVisibility() == true) {
                // @ts-expect-error TS(2339): Property 'setVisibility' does not exist on type 'H... Remove this comment to see the full error message
    ...
    /**タブを右クリック */
    function tabRightClickMenu(p: any) {
        let GPO = Grid_Property[Grid_Total.Layer].Ope;
        ...
        function mnuTabRightMenuMove(e: any) {
        ...
        function mnuTabRightMenuChangeTabName() {
            removeEventlister();
            Generic.prompt(undefined, "新しい" + Grid_Total.LayerCaption + "名", Grid_Property[Grid_Total.Layer].LayerName, function (newLayerName: any) {
                if (newLayerName == "") {
                } else {
                    // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
        ...
        function mnuTabRightMenuInsert(e: any) {
            let nt;
            if (e.caption == "前に挿入") {
                nt = Grid_Total.Layer;
            } else {
    ...
    function Swap_GridLay(L1: any,L2: any){
    ...
    /**レイヤを削除 */
    function Delete_Layer(DLay: any) {
        Grid_Total.LayerNum--;
    ...
    function mdown(e: any) {
        ...
        if (GR.Enable != 0) {
            ...
            if (rightButton == false) { //左クリック
                if ((xx < -Grid_Total.FixedObjectName_n + Grid_Total.FixedObjectName_n2
                ) && (yy < -Grid_Total.FixedDataItem_n + Grid_Total.FixedDataItem_n2)) { //左上端をクリック
    ...
    function mmove(e: any) {
        ...
        e.preventDefault();
        // @ts-expect-error TS(2339): Property 'getVisibility' does not exist on type 'H... Remove this comment to see the full error message
        if(txtTextBox.getVisibility()==true){return;}
    ...
    function Key_Move(KeyCode: any, Shit_f: any) {
    ...
    /**テキストボックス中でのキー操作 */
    function txtTextBox_KeyDown(e: any) {
        ...
        switch (e.keyCode) {
            ...
            case Keys.Tab: {
                ...
                Set_Data_from_txtBox_To_Grid();
                Key_Move(e.keyCode, Shift_Key);
                if ((e.keyCode == Keys.Up) && (GY == -1) && (((GP.Ope.FixedYSEnabled == false) && (GX >= 0)
                ) || ((GP.Ope.FixedUpperLeftEnabeld == false) && (GX < 0)))) {
                    GP.SelectedF = true;
                    SetTextBox(GX, GY);
                    // @ts-expect-error TS(2339): Property 'setVisibility' does not exist on type 'H... Remove this comment to see the full error message
                    txtTextBox.setVisibility(false);
    ...
    function Scroll_Set(X: any, Y: any) {
    ...
    function check_Width_Height_Change(mx: any, my: any) {
    ...
    function Print_GridResizeLine(mox: any, moy: any) {
        let w, H;
        // @ts-expect-error TS(2531): Object is possibly 'null'.
    ...
    function Grid_Resize_MouseUp(X: any, Y: any) {
        let S1, s2, T, TY, tx;
        let w, H;
    ...
    function ChangeRowHeight(Layer: any, top: any, bottom: any, Height: any) {
        let GP = Grid_Property[Layer];
        for (let i = top; i <= bottom; i++) {
            if (i < 0) {
    ...
    function ChangeColumnWidth(Layer: any, left: any, right: any, Width: any) {
        let GP = Grid_Property[Layer];
    ...
    function SetUndo_ChangeColumnWidth(Layer: any, left: any, right: any, Width: any) {
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    function GetGridXY(MouseX: any, MouseY: any, ZaroLine_F: any) {
    ...
    function GetGridX(MouseX: any, ZaroLine_F: any) {
        let GridX;
        let GP = Grid_Property[Grid_Total.Layer];
        let w = 0;
    ...
    function GetGridY(MouseY: any, ZaroLine_F: any) {
        let GridY;
        let H = 0;
    ...
    function SetGrid_UndoData(Layer: any,rect: any,GridData: any){
        let  SN  = 0;
...
let scrollBar = function(
    ...
    /**長さを変更 */
    this.setLength = function (newLength: any) {
        length = newLength;
    ...
    /**表示非表示 */
    this.setVisibility = function(visiflag: any){
        if (visiflag == true) {
            addEvent();
    ...
    /**スクロールバーの位置設定 */
    this.setXY = function (x: any, y: any) {
        frame.style.left = x.px()
        frame.style.top = y.px()
    }

    /**スクロールバーの位置取得 */
    this.getXY = function (x: any, y: any) {
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
        return new point(frame.style.left.removePx(), frame.style.top.removePx());
    }

    /**スライダーの位置を設定 */
    this.setPosition = function (newPosition: any) {
    ...
    /**最大値を設定 */
    this.setMaxValue = function (newMax: any) {
        maxValue = newMax;
    ...
    /**エリアレンジを設定 */
    this.setAreaRange = function (newAreaRange: any) {
