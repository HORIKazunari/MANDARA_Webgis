...
class clsDraw {
    ...
    static print(g: any, Word: any, P: any, Font_P: any, HorizonalAlignment: any, VerticalAlignment: any, ScrData: any) {
    ...
    static DrawText2(g: any, P: any, Tx: any, P_Font: any, ScrData: any) {
        let TH;
        if (ScrData.SampleBoxFlag == false) {
 ...
 */
static TextCut_for_print(g: any, T: any, P_Font: any, Orikaesi_F: any, Max_Width: any, ScrData: any) {
    ...
    static DrawPolyPolygon(g: any, Polydata: any, Fcolor: any) {
 ...
 * @param {*} AllnPolyP 
 */
static ClipPolyPolygon(g: any, pxy: any, AllnPolyP: any) {
    ...
    static Ellipse(g: any, Point: any, r: any, InnerColor: any, BorderColor: any, width: any) {
        g.beginPath();
    ...
    static Draw_Tile_and_Paint_and_Line(g: any, pxy: any, nPolyP: any, polyn: any, Tile: any, LinePat: any, ScrData: any) {
...
class clsDrawMarkFan {
    static init() {
        let mark_info = function(this: any) {
            this.name;
            this.stac;
        }
        //'最初の数値：記号内の要素の数
...
static Blend(i: any, k: any, T: any, Kvalue: any, Maxpt: any) {
 ...
 * @returns 
 */
var clsTileMap=function(this: any) {
