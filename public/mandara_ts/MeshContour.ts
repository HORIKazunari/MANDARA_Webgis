 ...
 * @returns 
 */
var conPart_info=function(this: any) {
 ...
 * @returns 
 */
var contourLineStacInfo = function(this: any, ContourNumber: any, NumOfPoint: any) {
...
var clsMeshContour = function(
    ...
    var Quad_Mesh_Info = function(this: any, Positon: any, Max: any, Min: any, LackF: any) {
        /// <signature>
    ...
    var Quad_MeshData: any = []; //Quad_Mesh_Info
    var PCell: any = [];
    ...
    this.SetMeshValue = function (x: any, y: any, Value: any) {
        Mesh[x][y] = Value;
    }
    this.GetMeshValue = function (x: any, y: any) {
        return Mesh[x][y];
    }
    this.Execute_Mesh = function (ContourNum: any, Contour_High_M: any, Con_LineStac: any) {
        /// <signature>
        ...
        for (let i = 0; i < High_CN.length;i++) { High_CN[i] = 0;}
    ...
    this.Execute_FrameGet = function (GetSide: any, ContourNum: any, Contour_High_M: any, Frame_LineContour: any, Frame_Point: any) {
        /// <signature>
    ...
    function GetFrameSub(ContourNum: any, Contour_High_M: any, sx: any, sy: any, Xplus: any, Yplus: any, LoopNum: any, Vpoint: any, Vcon: any) {
        // Contour_High_M[]
        //Vpoint[]:point
        //Vcon[]
        let SepV = [];
    ...
    function Mesh_Sub(con: any, Mesh: any, mi: any, mj: any, HK: any, High: any, High_CN: any) {
        //メッシュ内で横切る等値線を取得
        var V1 = Mesh[mi][mj];
        var V2 = Mesh[mi + 1][mj];
        var V3 = Mesh[mi][mj + 1];
    ...
    function R2220(mi: any, mj: any, C12: any, C34: any, C24: any, C13: any, VH1: any, VH2: any, VH3: any, VH4: any, V1: any, V2: any, V3: any, V4: any, HK: any, High_CN: any, con: any) {
        let T = 0;
        let po = new Array(4);
        if(C12 == 1 ){
            // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    ...
    function Get_Sum_geometric_progression(shokou: any, kouhi: any, n: any) {
        /// <signature>
    ...
    function Get_MortonArrayPosition(n: any) {
        /// <signature>
    ...
    function Get_MortonNumberXY(X: any, Y: any, SpaceLevel: any, max_PartitiopnLevel: any) {
        /// <signature>
    ...
    function Set_MeshQuadTree(Mesh: any, xw: any, yw: any, max_PartitiopnLevel: any) {
        /// <signature>
    ...
    //
    function Get_Quad_MeshCell(value: any, Qcell: any, SpaceLevel: any, Scell: any, n: any, max_PartitiopnLevel: any) {
        /// <signature>
    ...
    function Get_PartitiopnLevel(xs: any, ys: any) {
        /// <signature>
