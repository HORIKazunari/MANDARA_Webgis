 ...
 * @param {*} buttonOK 
 */
function clsGrid(newDataFlag: any,buttonOK: any){
    const Layer_Data_Info = function(this: any) {
        this.Data; // Integer
        this.Layer; // Integer
    }
    const Layer_Data_InfoCheck = function(this: any) {
        this.Data; // Integer
        this.Layer; // Integer
        this.Value; // Double
    }
    const GridLayerData_Info = function(this: any) {
        this.MapFile; // String
        this.Type; // String
        this.Shape; // String
        this.Time; // String
    ...
    let Change_Data;
    let ZahyoOk: any; // Boolean
    // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
    let newAttrData=new clsAttrData();;
    let SearchSTR=""; // String
    let D_CheckDataValue: any; // List(Of Double())
    ...
    Generic.createNewButton(gbSearch, "検索", "", 10, 10, function(e: any){
        ktGrid.removeEventlister();
        Generic.prompt(e,"検索文字列",SearchSTR,function(v: any){
    ...
    const cboLayerType=Generic.createNewWordSelect(gbLayerData,"レイヤの種類",[],0,"",10,205,undefined,140,1,function(obj: any, sel: any, ltype: any){
    ...
    const cboLayerShape = Generic.createNewWordSelect(gbLayerData, "レイヤの形状", [], 0, "", 10, 260, undefined, 100, 1, function (obj: any, sel: any, v: any) {
        ktGrid.setLayerData(ktGrid.getLayer(), GridLayerData.Shape, v);
        ErrorCheck();
    }, "", "", false);
    const cboMesh = Generic.createNewWordSelect(gbLayerData, "メッシュ", [], 0, "", 10, 315, undefined, 100, 1, function (obj: any, sel: any, v: any) {
    ...
    function Add_Layer(InsertPoint: any) {
        let w=[];
    ...
    /**表示レイヤを変更した場合に発生 */
    function Change_LayerSelect(Layer: any, PreviousLayer: any) {
        Set_LayerTypeShape();
        ErrorCheck();
    }
    /**上部の固定部分の枠２行目をクリックした場合に発生 */
    function Click_FixedYS2(cbl: any, cbx: any, cby: any, Value: any, Top: any, Left: any, Width: any, Height: any,e: any) {
        switch (cby) {
            case 1: {
        ...
        function dMissing(e: any){
            ktGrid.setFixedYSData(cbl, cbx, cby,e.caption);
            ktGrid.refresh();
        }
        function dtype(e: any) {
            ktGrid.setFixedYSData(cbl, cbx, cby,e.caption);
    ...
    /**データ部分をクリックした場合に発生 */
    function Click_DataGrid(Layer: any, X: any, Y: any, Value: any, Top: any, Left: any, Width: any, Height: any) {
    ...
    /**レイヤ名の変更、レイヤの移動などで発生 */
    function Change_Layer(LayerNameChange: any, LayerMove: any, LayerDelete: any) {
    ...
    function Check_Kencode_XY(NewL: any,OldL: any){
    ...
    function Check_Data2( L: any ,  D: any ,  CheckLevel: any ,  CheckedData: any ){
    ...
    function Check_ObjectNameLayer(LayerNum: any){
        let eMes=[];
        let Enable_Obj  = 0;
    ...
    function Check_DataKind(Layernum: any ){
    ...
    function set_First_GridCellWidthHeight(Layernum: any){
    ...
    function Get_Data_Property_Value(_attrData: any,Layernum: any,DataNum: any){
    ...
    function check_DataKind_and_Allignment(Layernum: any){
        for(let i  = 0 ;i< ktGrid.getXsize(Layernum);i++){
