 ...
 * @returns 
 */
var strLayerInfo = function(this: any) {
    this.Name;
    this.MapfileName;
    this.UseObjectKind = [];
    this.Time;
 ...
 * @param {*} locSearch 
 */
let setting = function (locSearch: any) {
    ...
    Generic.createNewImageButton(divpanel, "settingWindowBtnPrintError", "image/Warning_yellow_7231_20x20.png", 290, 20, 20, 20, function (e: any) {
        //エラーボタン
    ...
    Generic.createNewImageButton(divpanel, "settingWindowBtnConditionInfo", "image/Find_VS.png", 315, 20, 20, 20, function (e: any) {
        //属性検索設定ボタン
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    //モードのdivにenter
    function modeEnter(this: any, e: any) {
    ...
    function modeLeave(this: any, e: any) {
        if(this.selected == false) {
    ...
    /**複数表示モードをクリック */
    function multiModeClick(this: any) {
        clearModeIcon();
        let selDiv;
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    /**複合表示モードをクリック */
    function ComplexModeClick(this: any) {
        clearModeIcon();
        let selDiv;
        switch (this.id) {
            case "divOverlay":
    ...
    function menuReadData() {
        readData(okButton);
        function okButton(mapdata: any, attrText: any, filename: any, ext: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            attrData = new clsAttrData();
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    /**空間検索メニュー */
    function mnuSpatialSearch(e: any){
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        let Layernum = attrData.TotalData.LV1.SelectedLayer;
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        let oldData = attrData.LayerData[Layernum].atrData.Count;
        frmMain_Buffer(function (e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    function Check_EraseSettei_OK(okCall: any){
    ...
    /**面積・周長取得メニュー */
    function mnuAreaPeripheri(e: any) {
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        let Layernum = attrData.TotalData.LV1.SelectedLayer;
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        ...
        frmMain_AreaPeripheri(function (e: any) {
            addNewDataItem(e);
        });
    }

    /**データ計算メニュー */
    function mnuCulc(e: any){
        frmMain_Culc(function (e: any) {
            addNewDataItem(e);
        });
    }

    function addNewDataItem(e: any){
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        let Layernum = attrData.TotalData.LV1.SelectedLayer;
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    /**距離測定メニュー */
    function mnuMeasureDistance(e: any){
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        let Layernum = attrData.TotalData.LV1.SelectedLayer;
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        if (attrData.LayerData[Layernum].MapFileData.Map.Detail.DistanceMeasurable == false) {
        ...
        frmMain_GetDistance(function (e: any) {
            // @ts-expect-error TS(2554): Expected 3 arguments, but got 2.
    ...
    function mnuSetSeriesMode() {
        frmMain_SetSeriesMode(function (selIndex: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            attrData.TotalData.LV1.Print_Mode_Total = enmTotalMode_Number.SeriesMode;
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    function mnuMarkPosition(){
        frmMain_MarkPosition(function(mode: any,x: any,y: any){          
            switch (mode){
                 case 0: 
                case 1:
                case 5: {
    ...
    function AbountInner(parent: any,x: any,y: any){
    ...
    function menuSaveData(){
        ...
        Generic.prompt(undefined,"属性データファイル名",fname,function(v: any){
    ...
    function menuSaveMDRMJData(){
        ...
        Generic.prompt(undefined,"地図データ付属形式属性データファイル名",fname,function(v: any){
    ...
    function seriesSet(e: any) {
        ...
        function setSeries(DataSetNum: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let ats = attrData.TotalData.TotalMode.Series;
    ...
    function changeDataItem(obj: any, sel: any, v: any) {
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        let LayerNum = attrData.TotalData.LV1.SelectedLayer;
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    function SetPicPnlSoloDataEnabled(solomode: any, LayerNum: any, DataNum: any) {
        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
    ...
    //表示モードセレクタのEnabel設定
    //Mode:enmSelectMode
    function SetPicPnlDataEnabled(Mode: any, Flag: any) {
    ...
    /**グラフモードの表示データ項目を設定 */
    function pnlGraphEachItem(newRow: any){
        ...
        function selItemBorder(newSelRow: any) {
            // @ts-expect-error TS(2531): Object is possibly 'null'.
            if (pnl.selectedRow != -1) {
                // @ts-expect-error TS(2531): Object is possibly 'null'.
                document.getElementById("pnlGraphIteminPanel" + String(pnl.selectedRow)).style.borderColor = 'white';
    ...
    /**データ取得後の共通処理 */
    function initAfterGetData(non_clearf: any){
    ...
    */
    function Init_Screen_Set(Non_Clear_Flag: any) {
...
*/
    ...
    function frmSettingMode() {
        ...
        function btnClassODSettings(e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let Layernum = attrData.TotalData.LV1.SelectedLayer;
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            ...
            function LColorChange(data: any, e: any) {
                // @ts-expect-error TS(2304): Cannot find name 'attrData'.
                let ldd = attrData.nowDataSolo();
                // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
        ...
        function btnClassODOriginSettings(e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let ldd = attrData.nowDataSolo().ClassODMD;
            frmMain_LayeObjectSelectOne(true, ldd.o_Layer, ldd.O_object, ldd.Dummy_ObjectFlag, function (lay: any, obnum: any, dumF: any) {
        ...
        //階級記号モードの記号設定ボタン
        function classMarkButton(e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            ...
            // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
            Generic.ceatePopupMenu(popmenu, new point(e.clientX, e.clientY));
            function setSameMark(data: any, e: any) {
            ...
            function innerDataSet(data: any, e: any) {
                // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        ...
        function picPointMark_Click(e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let Layernum = attrData.TotalData.LV1.SelectedLayer;
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let md = attrData.LayerData[Layernum].LayerModeViewSettings.PointLineShape;
        ...
        //階級区分方法クリック
        function cboDivisionMethodChange(obj: any, sel: any, v: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let Layernum = attrData.TotalData.LV1.SelectedLayer;
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let DataNum = attrData.LayerData[Layernum].atrData.SelectedIndex;
        ...
        //階級分割数クリック
        function cboDivisionCountChange(obj: any, sel: any, v: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let Layernum = attrData.TotalData.LV1.SelectedLayer;
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let DataNum = attrData.LayerData[Layernum].atrData.SelectedIndex;
        ...
        Generic.createNewWordSelect(gbContourDrawMethod, "密度", cboDetailedList, 0, "contourDetailed", 10, 70, 40, 80, 0,
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            function (obj: any, sel: any, v: any) { attrData.nowDataSolo().ContourMD.Detailed = v }, "", "", true);
        const gbContourLineLpat = Generic.createNewFrame(contourView, "gbContourLineLpat", "", 190, 0, 90, 55, "等値線線種");
        Generic.createNewCanvas(gbContourLineLpat, "contourLinePat", "imgButton", 20, 15, 50, 30, function (e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        ...
        function btnMarkLineEdge(e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        ...
        Generic.createNewWordSelect(markBlockView, "記号の重なり", cboOverlapList, 0, "markBlockOverlap", 0, 335, undefined, 100, 0,
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            function (obj: any, sel: any, v: any) { attrData.nowDataSolo().MarkBlockMD.Overlap = v }, "", "", false);
        ...
        Generic.createNewButton(stringView, "フォント", "", 30, 30, function (e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
        ...
        Generic.createNewCanvas(gbGraphLineLpat, "graphLinePat", "imgButton", 35, 10, 50, 25, function (e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            let selGraph = attrData.nowGraph();
            switch (selGraph.GraphMode) {
                case enmGraphMode.PieGraph:
        ...
        Generic.createNewButton(gbLabelObjName, "フォント", "", 155, 12, function (e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
            ...
            function (e: any) {
                ...
                clsSelectData(e, attrData, attrData.TotalData.LV1.SelectedLayer,
                    function (selected: any, selectedNumber: any) {
                        let adList = [];
                        let selN: any = lstLabelDataItem.length;
                        selN = (selN == -1) ? 0 : selN;
                        // @ts-expect-error TS(2304): Cannot find name 'attrData'.
                        let Layernum = attrData.TotalData.LV1.SelectedLayer;
                        for (let i = 0; i < selectedNumber.length; i++) {
        ...
        Generic.createNewButton(gbLabelDataItem, "フォント", "", 230, 125, function (e: any) {
            // @ts-expect-error TS(2304): Cannot find name 'attrData'.
 ...
 * @param {*} okCall 
 */
function openShapeFile(okCall: any){
    let shapeFiles: any = [];//clsShapefile
