 ...
 * @returns 
 */
var clsSortingSearch = function(this: any) {
    var SortNumber: any = [];
    var Sortrr: any = [];
    var DataNum: any ;
    ...
    this.getAfterSortPosition = function (originalPosition: any){
        return SortNumber.indexOf(originalPosition);
    }

    /**元のデータのPositionのソート後の後ろからの位置を返す */
    this.getAfterSortPositionRev = function (originalPosition: any) {
    ...
    this.SameValue_Array = function (SameValueArray: any) {
        /// <signature>
    ...
    this.SearchData_Array = function (SearchValue: any) {
        /// <signature>
    ...
    this.SearchData_One = function (SearchValue: any) {
        /// <signature>
    ...
    this.DataPosition = function (Order: any) {
        /// <signature>
    ...
    this.DataPositionRev = function (OrderReverse: any) {
        /// <signature>
    ...
    this.DataPositionValue = function (Order: any) {
        /// <signature>
    ...
    this.DataPositionRevValue = function (OrderReverse: any) {
        /// <signature>
    ...
    this.AddRange = function (ValueArray: any) {
    ...
    function Sorting( n: any , sortdt: any ) {
        //'===========================================================
    ...
    function Search_Data_Multi( SearchValue: any ){
        //'-------------------------
        //'SearchValue／探し出すデータ
    ...
    function Get_Same_value(SameV: any) {
        //同じ値が含まれているケースを返す
        SameV.length = 0;
        let f =false;
