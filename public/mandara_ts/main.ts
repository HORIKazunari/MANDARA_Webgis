import './clsGeneric.js';
import './clsAttrData.js';
import './clsTime.js';
import './clsMapdata.js';
import './clsPrint.js';
import './clsDraw.js';
import './clsWindow.js';
...
function init() {
    ...
    function FrmprintMenuClick(pos: any) {
 ...
 * @param {*} e 
 */
function contextMenuPrevent(e: any){
    e.preventDefault();
}
...
function frmPrintProjection() {
    ...
    function okButton(newZahyo: any) {
