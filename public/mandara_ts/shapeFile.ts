...
clsShapefile = function(this: any) {

    let shapefile_info = function(this: any) {
        this.FileName;
        this.FullPath;
        this.Zahyo;
        this.prj_file_exist;
    ...
    let IndexFileData_info = function(this: any) {
        this.offset;
        this.contentsLength;
    }
    let XY_Genten_Info = function(this: any) {
        this.CenterB;
        this.CenterL;
    }
    let XYMaxMin_Double = function(this: any) {
        this.XMin;
        this.Ymin;
        this.Xmax;
        this.YMax;
    }
    let XY_Double = function(this: any) {
        this.x;
        this.y;
    }

    let DBF_Info = function(this: any) {
        this.VerData;
        this.RecordNumber;
        this.FieldNumber;
        this.Year;
    ...
    let Field_Info = function(this: any) {
        this.Name;
    ...
    let boundBox = function(this: any) {
        this.maxX;
        this.minX;
        this.maxY;
        this.minY;
    ...
    this.setMapZahyo=function(zahyo: any){
    ...
    this.fileRead = function (files: any, dbfEncode: any, _tag: any, onOK: any, _onError: any) {
        onError = _onError;
        tag = _tag;
        let shxFile;
        let shapeFile: any;
    ...
    /**zipファイル圧縮シェープファイル */
    this.fileReadZip= function (unZipData: any, dbfEncode: any, _tag: any, onOK: any) {
        tag = _tag;
        let shxFile;
        let shapeFile;
        let dbfFile;
    ...
    //prjファイル読み込み
    // @ts-expect-error TS(2304): Cannot find name 'getPrjFile'.
    getPrjFile = function (Prjtext: any) {
    ...
    //dbfファイル読み込み
    // @ts-expect-error TS(2304): Cannot find name 'getDbfFile'.
    getDbfFile = function (buffer: any, encodenumber: any) {
        ...
        function Get_WCharData_Binary(Position: any, GetLen: any, encode: any) {
            let ubt = [];
    ...
    //shxファイル読み込み
    // @ts-expect-error TS(2304): Cannot find name 'getSHXFile'.
    getSHXFile = function (buffer: any) {
    ...
    //shpファイル読み込み
    // @ts-expect-error TS(2304): Cannot find name 'getShapeFile'.
    getShapeFile = function (buffer: any) {
            const dv = new DataView(buffer);
        ...
        function getPointXY(dv: any, pos: any) {
    ...
    this.convertToMapfile = function (projection: any,UnitCheckFlag: any) {
        // @ts-expect-error TS(7009): 'new' expression, whose target lacks a construct s... Remove this comment to see the full error message
