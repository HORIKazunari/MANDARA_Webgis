 ...
 */
export type Tile = Tile_Property;
...
/**
 * フォント型（Font_Propertyクラスのエイリアス）
 */
export type Font = Font_Property;

/**
 * エッジ型（Edge_Propertyクラスのエイリアス）
 */
export type Edge = Edge_Property;
