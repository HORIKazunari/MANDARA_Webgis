...
function clsColorPicker(event_point: any, okEvent: any) {
    ...
    for (var i = 0; i <= 55; i++) {
        ...
        style.top = Math.floor((i % 7) * (colPSize.picH + colPSize.picInterval) + colPSize.picMargin+scrMargin.top) + "px";
...
function frmCompassSettings(_compass: any,okEvent: any){
    ...
    Generic.createNewButton(gbCompWord, "フォント", "", 40, 135,
        function (e: any) {
            clsFontSet(e, comp.Font, function (newFont: any) { comp.Font = newFont }, attrData);
...
function frmPrintOption(firstTab=0){
    ...
    function(e: any){
        clsFontSet(e, atv.MapTitle.Font, function (newFont: any) { atv.MapTitle.Font = newFont }, attrData);
    },"padding-top:0;padding-bottom:0");
    ...
    function(e: any){
        clsFontSet(e, atv.DataNote.Font, function (newFont: any) { atv.DataNote.Font = newFont }, attrData);
    },"padding-top:0;padding-bottom:0");
    ...
    Generic.createNewButton(tabLegend.panel[0], "凡例フォント", "", 30, 25, 
        function(e: any){
            clsFontSet(e, atv.MapLegend.Base.Font, function (newFont: any) { atv.MapLegend.Base.Font = newFont }, attrData);
        }, "");
    ...
    Generic.createNewButton(tab.panel[4], "フォント", "", 30, 55,
        function (e: any) {
            clsFontSet(e, atvs.Font, function (newFont: any) { atvs.Font = newFont }, attrData);
        }, "");
