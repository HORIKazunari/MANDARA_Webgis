...
function mapMouseInternal(elem: HTMLCanvasElement, callback: (element: HTMLCanvasElement, attrData?: IAttrData) => void): void {
    ...
    function keyOperation(keyCode: number, shiftKey: boolean, ctrlKey: boolean): void {
        ...
        const vs = attrData.TotalData.ViewStyle.ScrData.ScrView;
    ...
    function OD_Line_Print(g: CanvasRenderingContext2D, P: point){
        ...
        let pxy = splineGet ? splineGet(0, 4, poxy, 0.1, attrData.TotalData.ViewStyle.ScrData) : poxy;
            ...
            case enmTotalMode_Number.DataViewMode: {
                ...
                if (L_Print_Mode_Layer != enmLayerMode_Number.TripMode) {
                    switch (OnObject.length) {
                        ...
                        case 1: {
                            if ((typeof propertyWindow.getVisibility === "function") && (propertyWindow.getVisibility() == true) && (attrData.TempData.frmPrint_Temp.PrintMouseMode == enmPrintMouseMode.Normal)) {
    ...
    function Get_Object_By_XY_OverLayMode(MapP: point, OverLayIndex: number) {
        ...
        if (typeof propertyWindow.getVisibility === "function" && propertyWindow.getVisibility() == true) {
            ...
            if (propertyWindow.pnlProperty.objInfo) {
...
class frmPrint {
        ...
        function showLinePattern(){
            ...
            function inePatternClick(e: Event){
                ...
                function LinePatternGet(Lpat: any) {
                    ...
                    attrData.Draw_Sample_LineBox(target, Lpat);
                }
            }
        }
}
    ...
    static windowClose(){
        propertyWindow.nextVisible=(typeof propertyWindow.getVisibility === "function") ? (propertyWindow.getVisibility()==true) : false;
    ...
    static set_frmPrint_Window_Size() {
        ...
        const marginSide = scrMargin.side ?? 0;
        const marginTop = scrMargin.top ?? 0;
        const marginBottom = scrMargin.bottom ?? 0;
        ...
        propertyWindow.style.top=(Frm_Print.style.top.removePx()+marginTop).px();
